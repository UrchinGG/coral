...
impl Default for CoreTables {
    fn default() -> Self {
        Self {
            pkt_chat: 0x02,
            pkt_entity_equipment: 0x04,
            pkt_update_health: 0x06,
            pkt_respawn: 0x07,
            pkt_player_position_and_look: 0x08,
            pkt_held_item_change: 0x09,
            pkt_animation: 0x0B,
            pkt_spawn_player: 0x0C,
            pkt_destroy_entities: 0x13,
            pkt_entity_relative_move: 0x15,
            pkt_entity_look: 0x16,
            pkt_entity_look_and_relative_move: 0x17,
            pkt_entity_teleport: 0x18,
            pkt_entity_status: 0x1A,
            pkt_entity_metadata: 0x1C,
            pkt_set_experience: 0x1F,
            pkt_chunk_data: 0x21,
            pkt_multi_block_change: 0x22,
            pkt_block_change: 0x23,
            pkt_block_break_animation: 0x25,
            pkt_map_chunk_bulk: 0x26,
            pkt_open_window: 0x2D,
            pkt_close_window: 0x2E,
            pkt_set_slot: 0x2F,
            pkt_window_items: 0x30,
            pkt_player_list_item: 0x38,
            pkt_scoreboard_objective: 0x3B,
            pkt_update_score: 0x3C,
            pkt_display_scoreboard: 0x3D,
            pkt_teams: 0x3E,
            pkt_player_list_header_footer: 0x47,
            pkt_plugin_message: 0x3F,
            coord_scale: 32.0,
            rotation_scale: 360.0 / 256.0,
            player_entity_type: 0,
            player_list_action_add: 0,
            player_list_action_update_gamemode: 1,
            player_list_action_update_ping: 2,
            player_list_action_update_display_name: 3,
            player_list_action_remove: 4,
            team_mode_create: 0,
            team_mode_remove: 1,
            team_mode_update: 2,
            team_mode_add_players: 3,
            team_mode_remove_players: 4,
        }
    }
}
