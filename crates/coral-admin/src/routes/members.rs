...
struct StandingView {
    ...
    tag_reason: String,
    effective_level: i16,
    standing_override: Option<String>,
...
async fn detail(
    ...
    let standing = StandingView {
        ...
        standing_override: member.standing_override.clone(),
        override_by: member.standing_override_by,
        override_at: member.standing_override_at,
