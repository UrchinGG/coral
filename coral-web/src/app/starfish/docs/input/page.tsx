  ...
  return (
    <div>
      ...
      <Section title="Text capture">
        ...
        <P>Ending the session yourself doesn't fire <Mono>onCancel</Mono>. Starfish closes it for you, and does fire <Mono>onCancel</Mono>, if a click lands outside every hit region or the game recaptures the mouse: cases a plugin can't otherwise detect.</P>
      </Section>
      ...
      <Section title="Mouse capture">
        ...
        <Signature>{"session:stop() -> nil"}</Signature>
        <P>Ending the session yourself doesn't fire <Mono>onCancel</Mono>. Pressing Escape closes it for you instead (the same guarantee a vanilla screen makes) and does fire <Mono>onCancel</Mono>.</P>
      </Section>
    </div>
  );
}
